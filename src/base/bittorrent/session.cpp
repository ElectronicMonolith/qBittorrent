...
Session::Session(QObject *parent)
    ...
    , m_announceToAllTiers(BITTORRENT_SESSION_KEY("AnnounceToAllTiers"), false)
    ...
    , m_filePoolSize(BITTORRENT_SESSION_KEY("FilePoolSize"), 768)
    , m_checkingMemUsage(BITTORRENT_SESSION_KEY("CheckingMemUsageSize"), 64)
    , m_diskCacheSize(BITTORRENT_SESSION_KEY("DiskCacheSize"), 7824)
    , m_diskCacheTTL(BITTORRENT_SESSION_KEY("DiskCacheTTL"), 70)
    ...
    , m_sendBufferWatermark(BITTORRENT_SESSION_KEY("SendBufferWatermark"), 20 * 1024)
    , m_sendBufferLowWatermark(BITTORRENT_SESSION_KEY("SendBufferLowWatermark"), 16)
    , m_sendBufferWatermarkFactor(BITTORRENT_SESSION_KEY("SendBufferWatermarkFactor"), 125)
    , m_connectionSpeed(BITTORRENT_SESSION_KEY("ConnectionSpeed"), 200)
    , m_socketBacklogSize(BITTORRENT_SESSION_KEY("SocketBacklogSize"), 300)
